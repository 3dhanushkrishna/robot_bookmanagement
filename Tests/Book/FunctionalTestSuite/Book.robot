...
User Registration test
    ...
    sleep  1s
    input text  name:add  karur
    sleep  1s
    input text  name:email  ${email}
    sleep  1s
    input text  name:pno  123456789
    sleep  1s
...
AddBook Admin test
    ...
    [Tags]  admin
    input text  name:name  sarkar
    sleep  1s
    input text  name:auth  murugados
    sleep  1s
    input text  name:cat  thrileer
    sleep  1s
    input text  name:price  2000
    sleep  1s
    input text  name:pub  Sun
    sleep  1s
...
Search Book test
    ...
    [Tags]  user
    sleep  2s
    click link  xpath://html/body/div[1]/div/div/div/nav/div/div/ul/li[4]/a
    sleep  1s
    input text  name:name  sarkar
    sleep  1s
    click button  xpath://html/body/div[2]/div/div[2]/form/center/button
...
ViewBook Admin test
    ...
    [Tags]  admin
    click link  xpath:/html/body/div[1]/div/div/div/nav/div/div/ul/li[2]/a
    sleep  3s

Update Book test
    [Documentation]  Updatebook page
    [Tags]  admin
    click link  xpath:/html/body/div[1]/div/div/div/nav/div/div/ul/li[3]/a
    sleep  1s
    input text  name:name  sarkar
    sleep  1s
    click button  xpath:/html/body/div[2]/div/div[2]/form/center/button
    ...
    sleep  3s
    input text  name:name  wings
    sleep  1s
    input text  name:auth  dhanush
    sleep  1s
    input text  name:cat  thriller
    sleep  1s
    input text  name:price  50000
    sleep  1s
    input text  name:pub  abc
    sleep  1s
...
Delete Admin test
    ...
    [Tags]  admin
    click link  xpath://html/body/div[1]/div/div/div/nav/div/div/ul/li[5]/a
    sleep  1s
    input text  name:name  wings
    sleep  1s
    click button  xpath:/html/body/div[2]/div/div[2]/form/center/button
...
Logout test
    ...
    [Tags]  user
    click Element  xpath:/html/body/div[1]/div/div/div/nav/div/div/ul/li[6]/a
    sleep  3s
    close browser
